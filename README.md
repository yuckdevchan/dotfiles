...
If you can't use [git](https://git-scm.com/) then click on the ***[Download ZIP](https://github.com/yuckdevchan/dotfiles/archive/refs/heads/main.zip)*** button on this repository.
